"""
Django settings for duivenvoorde project.
...
ROOT_URLCONF = 'duivenvoorde.urls'
...
WSGI_APPLICATION = 'duivenvoorde.wsgi.application'
...
# Grapelli admin
GRAPPELLI_ADMIN_TITLE='Beheer van grondwatermeetnet Duivenvoorde'
